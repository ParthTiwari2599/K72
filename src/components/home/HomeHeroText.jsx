...
const HomeHeroText = () => {
    return (
        <div className='font-[font1]  mt-72 lg:mt-0 pt-5 text-center'>
            <div className='lg:text-[9vw] text-[10vw] justify-center flex items-center uppercase lg:leading-[8vw] leading-[10vw]'>
                L'étincelle
            </div>
            <div className='lg:text-[9vw] text-[10vw] justify-center flex items-start uppercase lg:leading-[8vw] leading-[10vw]'>
                qui
